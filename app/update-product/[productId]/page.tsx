...
import { readProductById, updateProduct } from "../../components/actions";
          ...
          <div>
            ...
            <div className="flex md:flex-row flex-col md:items-center">
              ...
              <div className="flex md:flex-col md:ml-4 mt-4 md:mt-0">
                <div
                  className="md:ml-4 md:w-[200px] mt-4 md:mt-0 border-2 border-primary 
                        md:h-[200px] p-5 justify-center items-center rounded-3xl hidden md:flex"
                >
